...
{
    AdtSpclCompA,            ///< 专用比较基准A
    AdtSpclCompB,            ///< 专用比较基准B
...
typedef enum en_adt_ttrig_trigxs
{
    ...
    AdtTrigxSelPC7,         ///< PC7
    AdtTrigxSelPD7,         ///< PD7
    AdtTrigxSelPA11,        ///< PA11
    AdtTrigxSelPB11,        ///< PB11
    AdtTrigxSelPC11,        ///< PC11
    AdtTrigxSelPD1,         ///< PD1
    AdtTrigxSelPA15,        ///< PA15
    AdtTrigxSelPB15,        ///< PB15
    AdtTrigxSelPC5,         ///< PC5
    AdtTrigxSelPD5,         ///< PD5
...
typedef enum en_adt_itrig_iaosxs
{
    ...
    AdtAosxTrigSelLpUartInt,        ///< LPUART_INT
    AdtAosxTrigSelVc0Int,           ///< VC0_INT
...
typedef enum en_adt_hw_trig
{
    ...
    AdtHwTrigCHxARise,              ///< CHxA端口上采样到上升沿
    AdtHwTrigCHxAFall,              ///< CHxA端口上采样到下降沿
    AdtHwTrigCHxBRise,              ///< CHxB端口上采样到上升沿
    AdtHwTrigCHxBFall,              ///< CHxB端口上采样到下降沿
