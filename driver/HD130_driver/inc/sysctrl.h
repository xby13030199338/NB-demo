...
{
    SysctrlWkupByRCHEn,                        ///< 唤醒时使用RCH时钟
    SysctrlEXTHEn,                             ///< 使能外部高速时钟从输入引脚PD00输入
    SysctrlEXTLEn,                             ///< 使能外部低速速时钟从输入引脚PC14输入
    SysctrlXTLAlwaysOnEn,                      ///< 使能后XTL_EN只可置位
    SysctrlClkFuncRTCLpmEn,                    ///< 使能RTC低功耗模式
    SysctrlCMLockUpEn,                         ///< 使能后CPU执行无效指令会复位MCU
    SysctrlSWDUseIOEn,                         ///< SWD端口设为IO功能
}en_sysctrl_func_t;
