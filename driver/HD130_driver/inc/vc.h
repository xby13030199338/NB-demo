...
typedef enum en_vc_resp_filter
{
    ...
    VcFilter28us    = 1u,           ///< 输出滤波时间28us
    VcFilter112us   = 1u,          ///< 输出滤波时间112us
    VcFilter450us   = 1u,          ///< 输出滤波时间450us
    VcFilter1800us  = 1u,         ///< 输出滤波时间1.8ms
    VcFilter7200us  = 1u,         ///< 输出滤波时间7.2ms
    VcFilter28800us = 1u,        ///< 输出滤波时间28.8ms
}en_vc_resp_filter_t;
...
{
    VcInNCh0    = 0u,         ///< 输入通道0  PA0
    VcInNCh1    = 1u,         ///< 输入通道1  PA1
    VcInNCh2    = 2u,         ///< 输入通道2  PA2
    VcInNCh3    = 3u,         ///< 输入通道3  PA3
    VcInNCh4    = 4u,         ///< 输入通道4  PA4
    VcInNCh5    = 5u,         ///< 输入通道5  PA5
    VcInNCh6    = 6u,         ///< 输入通道6  PA6
    VcInNCh7    = 7u,         ///< 输入通道7  PA7
    VcInNCh8    = 8u,         ///< 输入通道8  PC4
    VcInNCh9    = 9u,         ///< 输入通道9  PC5
    VcInNCh10   = 10u,        ///< 输入通道10 PB0    
    ResDivOut   = 11u,        ///< Vcc分压
    AiTs        = 12u,        ///< 温度传感器
    AiBg1p2     = 13u,        ///< BGR 1.2V
    AiAdcVref   = 14u,        ///< ADCVREF
    AiLdo       = 15u,       ///< LDO
}en_vc_input_n_src_t;
...
{
    VcOutInvTimer = 0,              ///< 结果输出负向到各Timer0,1,2,3
    VcOutTIM0RCLR = 1,              ///< 结果使能输出到TIM0 REFCLR
    VcOutTIM1RCLR = 2,              ///< 结果使能输出到TIM1 REFCLR
    VcOutTIM2RCLR = 3,              ///< 结果使能输出到TIM2 REFCLR
    VcOutTIM3RCLR = 4,              ///< 结果使能输出到TIM3 REFCLR
    VcOutTIMBK    = 5,              ///< 结果使能输出到Timer0,1,2,3刹车
    VcOutInvTIM4  = 9,              ///< 结果输出负向到Timer4
    VcOutTIM4     = 10,             ///< 结果使能输出到Timer4
    VcOutInvTIM5  = 11,             ///< 结果输出负向到Timer5
    VcOutTIM5     = 12,             ///< 结果使能输出到Timer5
    VcOutInvTIM6  = 13,             ///< 结果输出负向到Timer6
    VcOutTIM6     = 14,             ///< 结果使能输出到Timer6
    VcOutBrake    = 15,             ///< 结果使能输出到Advanced Timer刹车
    VcOutDisable  = 16,             ///< 结果输出除能
