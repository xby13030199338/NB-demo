...
en_result_t Dma_InitChannel(en_dma_channel_t enCh, stc_dma_config_t* pstcConfig)
{
  ...
  if(enCh == DmaCh0)
  {   
    M0P_DMA->B0CR_f.FISIE = 0;
    M0P_DMA->B0CR_f.ERRIE = 0; /* Disable DMAC interrupt */
    
    /*******************  SET DMA MODE   ******************/    
    M0P_DMA->B0CR_f.MODE = pstcConfig->enMode;
    /*******************  SET DMA_TRGSELx register  ******************/
    M0P_DMA->A0CR_f.TRIGSEL = pstcConfig->enRequestNum;
    /*******************  SET DMA_DTCTLx(x=0~7) register  ******************/
    /* Block size */
    M0P_DMA->A0CR_f.BC = pstcConfig->u16BlockSize - 1;
    /* Transfer count */
    M0P_DMA->A0CR_f.TC = pstcConfig->u16TransferCnt - 1;
    
    /*******************  SET DMA_CHxCTL(x=0~7) register  ******************/
    /* Transfer width */
    M0P_DMA->B0CR_f.WIDTH = pstcConfig->enTransferWidth;
    
    /****************************** source address contrl *******************/
    /* source address mode */
    M0P_DMA->B0CR_f.FS = pstcConfig->enSrcAddrMode;
    /* Source address */
    M0P_DMA->SRCADR0_f.SRCADR0 = pstcConfig->u32SrcAddress;
    
    /*************************** destination address contrl *******************/
    /* destination address mode */
    M0P_DMA->B0CR_f.FD = pstcConfig->enDstAddrMode;
    /* Destination address */
    M0P_DMA->DSTADR0_f.DSTADR0 = pstcConfig->u32DstAddress;
    /*********************  Source address reload control  ********************/
    M0P_DMA ->B0CR_f.RS = pstcConfig->bSrcAddrReloadCtl;
    
    /*******************  Destination address reload control  *****************/
    M0P_DMA ->B0CR_f.RD = pstcConfig->bDestAddrReloadCtl;
    
    /*******************  Destination bc/tc reload control  *****************/
    M0P_DMA ->B0CR_f.RC = pstcConfig->bSrcBcTcReloadCtl;
    
   /*******************  MSK control  *****************/    
    M0P_DMA->B0CR_f.MSK = pstcConfig->bMsk;
    
  }
  else{
    M0P_DMA->B1CR_f.FISIE = 0;
    M0P_DMA->B1CR_f.ERRIE = 0; /* Disable DMAC interrupt */
    /*******************  SET DMA MODE   ******************/    
    M0P_DMA->B1CR_f.MODE = pstcConfig->enMode;
    /*******************  SET DMA_TRGSELx register  ******************/
    M0P_DMA->A1CR_f.TRIGSEL = pstcConfig->enRequestNum;
    /*******************  SET DMA_DTCTLx(x=0~7) register  ******************/
    /* Block size */
    M0P_DMA->A1CR_f.BC = pstcConfig->u16BlockSize - 1;
    /* Transfer count */
    M0P_DMA->A1CR_f.TC = pstcConfig->u16TransferCnt - 1;
    
    /*******************  SET DMA_CHxCTL(x=0~7) register  ******************/
    /* Transfer width */
    M0P_DMA->B1CR_f.WIDTH = pstcConfig->enTransferWidth;
    
    /****************************** source address contrl *******************/
    /* source address mode */
    M0P_DMA->B1CR_f.FS =  pstcConfig->enSrcAddrMode;
    /* Source address */
    M0P_DMA->DSTADR1_f.DSTADR0 = pstcConfig->u32SrcAddress;
    
    /*************************** destination address contrl *******************/
    /* destination address mode */
    M0P_DMA->B1CR_f.FD = pstcConfig->enSrcAddrMode;
    /* Destination address */
    M0P_DMA->SRCADR1_f.SRCADR0 = pstcConfig->u32DstAddress;
    
    /*********************  Source address reload control  ********************/
    M0P_DMA ->B1CR_f.RS = pstcConfig->bSrcAddrReloadCtl;
    
    /*******************  Destination address reload control  *****************/
    M0P_DMA ->B1CR_f.RD = pstcConfig->bDestAddrReloadCtl;
    
    /*******************  Destination bc/tc reload control  *****************/
    M0P_DMA ->B1CR_f.RC = pstcConfig->bSrcBcTcReloadCtl; 
    
    /*******************  MSK control  *****************/    
    M0P_DMA->B1CR_f.MSK = pstcConfig->bMsk;
  }
  return Ok;
}
...
void Dma_SwTrigger(en_dma_channel_t enCh)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->A0CR_f.TRIGSEL = 0x0000;
  }
  else{
    M0P_DMA->A1CR_f.TRIGSEL = 0x0000;   	
  }
}
...
void Dma_Start(en_dma_channel_t enCh)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->A0CR_f.START = 1;
  }
  else{
    M0P_DMA->A1CR_f.START = 1;   	
  }  
}
...
void Dma_Stop(en_dma_channel_t enCh)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->A0CR_f.START = 0;
  }
  else{
    M0P_DMA->A1CR_f.START = 0;   	
  }  
}
/**
*******************************************************************************
...
en_result_t Dma_SetTriggerSel(en_dma_channel_t enCh, en_dma_trig_sel_t enTrgSel)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->A0CR_f.TRIGSEL = enTrgSel;;
  }
  else{
    M0P_DMA->A1CR_f.TRIGSEL = enTrgSel;;   	
  }
...
en_result_t Dma_SetSourceAddress(en_dma_channel_t enCh, uint32_t u32Address)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->SRCADR0_f.SRCADR0 = u32Address;
  }
  else
  {
    M0P_DMA->SRCADR1_f.SRCADR0 = u32Address;;   	
  }
...
en_result_t Dma_SetDestinationAddress(en_dma_channel_t enCh, uint32_t u32Address)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->DSTADR0_f.DSTADR0 = u32Address;
  }
  else
  {
    M0P_DMA->DSTADR1_f.DSTADR0 = u32Address;   	
  }
...
en_result_t Dma_SetBlockSize(en_dma_channel_t enCh, uint16_t u16BlkSize)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->A0CR_f.BC = u16BlkSize - 1;
  }
  else
  {
    M0P_DMA->A1CR_f.BC = u16BlkSize - 1;   	
  }
  return Ok;
}
...
en_result_t Dma_SetTransferCnt(en_dma_channel_t enCh, uint16_t u16TrnCnt)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->A0CR_f.TC = u16TrnCnt - 1;
  }
  else
  {
    M0P_DMA->A1CR_f.TC = u16TrnCnt - 1;   	
  }
...
en_result_t Dma_SetSourceIncMode(en_dma_channel_t enCh, en_address_mode_t enMode)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->B0CR_f.FS = enMode;
  }
  else{
    M0P_DMA->B1CR_f.FS = enMode;   	
  }
...
en_result_t Dma_SetDestinationIncMode(en_dma_channel_t enCh, en_address_mode_t enMode)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->B0CR_f.FD = enMode;
  }
  else{
    M0P_DMA->B1CR_f.FD = enMode;   	
  }
...
en_result_t Dma_EnableContinusTranfer(en_dma_channel_t enCh)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->B0CR_f.MSK = 1;
  }
  else{
    M0P_DMA->B1CR_f.MSK = 1;  	
  }
  return Ok;
}
...
en_result_t Dma_DisableContinusTranfer(en_dma_channel_t enCh)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->B0CR_f.MSK = 0;
  }
  else{
    M0P_DMA->B1CR_f.MSK = 0;  	
  }
...
en_result_t Dma_SetTransferWidth(en_dma_channel_t enCh, en_dma_transfer_width_t enWidth)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->B0CR_f.WIDTH = enWidth;
  }
  else{
    M0P_DMA->B1CR_f.WIDTH = enWidth;  	
  }
...
en_result_t Dma_EnableChannelIrq(en_dma_channel_t enCh)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->B0CR_f.FISIE = 1;
  }
  else{
    M0P_DMA->B1CR_f.FISIE = 1;  	
  }
...
en_result_t Dma_EnableChannelErrIrq(en_dma_channel_t enCh)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->B0CR_f.ERRIE = 1;
  }
  else{
    M0P_DMA->B1CR_f.ERRIE = 1;  	
  }
...
en_result_t Dma_DisableChannelErrIrq(en_dma_channel_t enCh)
{
  ...
  if(enCh == DmaCh0)
  {
    M0P_DMA->B0CR_f.ERRIE = 0;
  }
  else{
    M0P_DMA->B1CR_f.ERRIE = 0;  	
  }
...
{
    if((DmaAddOverflow == M0P_DMA->B0CR_f.STAT)||(DmaHALT == M0P_DMA->B0CR_f.STAT)||(DmaAccSCRErr == M0P_DMA->B0CR_f.STAT) ||(DmaAccDestErr == M0P_DMA->B0CR_f.STAT))
    {
        if (NULL != stcDmaIrqCalbaks.pfnDma0TranferErrIrq)
        {
            stcDmaIrqCalbaks.pfnDma0TranferCompleteIrq();
        }
        M0P_DMA->B0CR_f.STAT = 0u;
    }
    if((DmaAddOverflow == M0P_DMA->B1CR_f.STAT)||(DmaHALT == M0P_DMA->B1CR_f.STAT)||(DmaAccSCRErr == M0P_DMA->B1CR_f.STAT) ||(DmaAccDestErr == M0P_DMA->B1CR_f.STAT))
    {
        if (NULL != stcDmaIrqCalbaks.pfnDma1TranferErrIrq)
        {
            stcDmaIrqCalbaks.pfnDma1TranferCompleteIrq();
        }
        M0P_DMA->B1CR_f.STAT = 0u;
    }	
    if(DmaTransferComplete == M0P_DMA->B0CR_f.STAT)
    {
    ...
    if(DmaTransferComplete == M0P_DMA->B1CR_f.STAT)
    {
        if (NULL != stcDmaIrqCalbaks.pfnDma0TranferCompleteIrq)
        {
            stcDmaIrqCalbaks.pfnDma1TranferCompleteIrq();
...
en_dma_stat_t Dma_GetStat(en_dma_channel_t enCh)
{
  ...
  if(enCh == DmaCh0)
  {
    return (en_dma_stat_t)M0P_DMA->B0CR_f.STAT ;
  }
  else{
    return (en_dma_stat_t)M0P_DMA->B1CR_f.STAT ;  	
  }	
}
//@} // DmacGroup
