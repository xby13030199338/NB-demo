 ...
 **
 ******************************************************************************/
 en_result_t I2C_WriteSlaveAddr(en_i2c_channel_t enCh,stc_i2c_addr_t stcSlaveAddr)
{
    en_result_t enRet = Error;
    if(I2C0 == enCh)
    {
        M0P_I2C0->ADDR_f.ADR = stcSlaveAddr.Addr;
        M0P_I2C0->ADDR_f.GC = stcSlaveAddr.Gc;
    }
    else
    {
        M0P_I2C1->ADDR_f.ADR = stcSlaveAddr.Addr;
        M0P_I2C1->ADDR_f.GC = stcSlaveAddr.Gc;   
    }
 ...
 **
 ******************************************************************************/
en_result_t I2C_Init(en_i2c_channel_t enCh,stc_i2c_config_t stcI2CCfg)
{
   en_result_t enRet = Error;
   enRet = I2C_SetFunc(enCh,stcI2CCfg.enFunc);
   enRet = I2C_SetBaud(enCh,stcI2CCfg.u8Tm);
   enRet = I2C_WriteSlaveAddr(enCh,stcI2CCfg.stcSlaveAddr);
   pfnI2c0tCallback = stcI2CCfg.pfnI2c0Cb;
   pfnI2c1tCallback = stcI2CCfg.pfnI2c1Cb;
