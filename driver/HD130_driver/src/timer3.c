...
/**
 *****************************************************************************
 ** \brief Base Timer3 比较捕获寄存器CCR0A/CCR0B设置(模式23)
 **
 **
...
/**
 *****************************************************************************
 ** \brief Base Timer3 比较捕获寄存器CCR0A/CCR0B读取(模式23)
 **
 **
 ** \param [in]  enCCRSel           CCR0A/CCR0B设定
 ** 
...
/**
 *****************************************************************************
 ** \brief Base Timer3 CH0A/CH0B比较通道控制(模式23)
 **
 **
 ** \param [in]  pstcConfig       初始化配置结构体指针
...
/**
 *****************************************************************************
 ** \brief Base Timer3 CH0A/CH0B输入控制(模式23)
 **
 **
 ** \param [in]  pstcConfig       初始化配置结构体指针
 ** \param [in]  enTim3Chx        Timer3通道(Tim3CH0, Tim3CH1, Tim3CH2)
